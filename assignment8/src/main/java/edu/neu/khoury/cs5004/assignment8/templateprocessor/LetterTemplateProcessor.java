 ...
 * @author evandouglass
 */
public class LetterTemplateProcessor extends AbstractTextTemplateProcessor {
   ...
   */
  public LetterTemplateProcessor(BufferedReader templateReader) throws IOException {
    super(templateReader);
    typeOfTemplate = "letter";
  }
}
